      ...
      <div className="flex flex-col items-center justify-center min-h-[200px] p-6">
        ...
        <div className="relative">
          <div className="w-24 h-24 rounded-xl bg-gradient-to-br from-[#90AB8B]/10 to-[#5A7863]/10 border-2 border-[#90AB8B]/30 group-hover:border-[#5A7863] transition-colors duration-300 flex items-center justify-center">
            {/* Plus icon */}
            <div className="relative">
              <div className="w-12 h-2 rounded-full bg-gradient-to-r from-[#5A7863] to-[#3B4953] group-hover:from-[#3B4953] group-hover:to-[#5A7863] transition-all duration-300" />

              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-2 h-12 rounded-full bg-gradient-to-b from-[#5A7863] to-[#3B4953] group-hover:from-[#3B4953] group-hover:to-[#5A7863] transition-all duration-300" />

              <div className="absolute inset-0 bg-gradient-to-r from-[#90AB8B]/0 to-[#5A7863]/0 group-hover:from-[#90AB8B]/10 group-hover:to-[#5A7863]/10 rounded-full blur-sm transition-all duration-300" />
            </div>
          </div>
